...
var databaseUrl = 'mongodb://localhost/nyt-scrapper';
...
// A GET route for scraping the nytimes.com website
//------------------------------------------------------
...
//Route to find all the saved articles
//---------------------------------------------------------------------
...
app.post("/note/:id", function(req, res) {
	...
	note.save(function(err, doc) {
		if (err) throw err;
		Article.findByIdAndUpdate(req.params.id, {$set: {"note": doc._id}}, {new: true}, function(err, newnote) {
			if (err) throw err;
			else {
				res.send(newnote);
			}
...
//Route to view the note already added to the article
//-----------------------------------------------------------------------------
